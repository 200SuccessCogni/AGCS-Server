...
const sentimentController = require('../controllers/reviews/llmSegmentation');
...
router.post("/review/genAIAnalysis",sentimentController.genAiAnalysis);
...
router.post("/review/genAIPlayground",sentimentController.genAiPlayground);
